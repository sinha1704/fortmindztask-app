...
//     }
  ...
  return (
    <div>
     <p style={{fontSize:"28px", fontWeight:"500", marginLeft:"5%", marginTop:"80px"}}>Saved Listings</p>
  ...
  <div className='topButtonSection' >
    ...
    <table style={{width:"90%", border:"1px solid #E3E3E5", borderRadius:"10px", marginLeft:"auto", marginRight:"auto"}}>
      <thead style={{height:"40px"}}>
        ...
        <th>Saved Date <ArrowUpwardIcon fontSize='6px'/> <ArrowDownwardIcon fontSize='6px' /></th>
        <th>Status</th>
      </thead>
      ...
      {currentItems.map((items, id)=>{
        return(
          ...
          <td style={{fontSize:"15px", color:"#3F4B63"}}>{items.saved_date}</td>
